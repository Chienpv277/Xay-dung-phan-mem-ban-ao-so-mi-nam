...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("hoadon", "HoaDon", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("thongke", "ThongKe", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("nhanvien", "NhanVien", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("sanpham", "SanPham", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("khachhang", "KhachHang", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("logo_ao_so_mi", "", Model_Menu.MenuType.MENU));
