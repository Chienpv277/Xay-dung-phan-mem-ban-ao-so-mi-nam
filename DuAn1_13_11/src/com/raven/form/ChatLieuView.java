...
public class ChatLieuView extends javax.swing.JFrame {
    ...
    public ChatLieuView() {
        initComponents();
        loadData(service.getListChatLieu());
    }

    public void loadData(ArrayList<ChatLieu> chatLieu) {
        int i = 1;
        defaultTableModel = (DefaultTableModel) tblChatLieu.getModel();
    ...
    private void initComponents() {
        ...
        tblChatLieu.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        for (ChatLieu existingChatLieu : service.getListChatLieu()) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (row != -1) {
            ChatLieu selected = service.getListChatLieu().get(row);
            String ten = txtTen.getText();
            ...
            if (confirmResult == JOptionPane.YES_OPTION) {
                if (service.update(selected.getId(), x)) {
                    JOptionPane.showMessageDialog(this, "Cập nhật thành công (id: " + x.getId() + ")");
                    loadData(service.getListChatLieu());
                } else {
    ...
    private void tblChatLieuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChatLieuMouseClicked
        int row = tblChatLieu.getSelectedRow();
        txtMa.setText(tblChatLieu.getValueAt(row, 1).toString());
        txtTen.setText(tblChatLieu.getValueAt(row, 2).toString());
