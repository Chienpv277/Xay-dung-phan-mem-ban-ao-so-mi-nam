...
public class HangView extends javax.swing.JFrame {
    ...
    public HangView() {
        initComponents();
        loadData(service.getListHang());
    }

    public void loadData(ArrayList<Hang> chatLieu) {
        int i = 1;
    ...
    private void initComponents() {
        ...
        tblHang.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        for (Hang existingHang : service.getListHang()) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (row != -1) {
            Hang selected = service.getListHang().get(row);
            String ten = txtTen.getText();
            ...
            int confirmResult = JOptionPane.showConfirmDialog(
                    this,
                    "Bạn có chắc chắn muốn cập nhật (id: " + selected.getId() + ")?",
                    "Xác nhận cập nhật",
    ...
    private void tblHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHangMouseClicked
        int row = tblHang.getSelectedRow();
        txtMa.setText(tblHang.getValueAt(row, 1).toString());
        txtTen.setText(tblHang.getValueAt(row, 2).toString());
