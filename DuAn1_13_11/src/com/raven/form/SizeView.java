...
public class SizeView extends javax.swing.JFrame {
    ...
    public SizeView() {
        initComponents();
        loadData(service.getListSize());
    }

    public void loadData(ArrayList<Size> size) {
        int i = 1;
    ...
    private void initComponents() {
        ...
        tblSize.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        for (Size existingSize : service.getListSize()) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (row != -1) {
            Size selected = service.getListSize().get(row);
            String ten = txtTen.getText();
    ...
    private void tblSizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSizeMouseClicked
        ...
        txtTen.setText(tblSize.getValueAt(row, 2).toString());
