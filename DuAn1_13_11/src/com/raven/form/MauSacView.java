...
public class MauSacView extends javax.swing.JFrame {
    ...
    public void loadData(ArrayList<MauSac> mauSac) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        loadData(service.getListMauSac());
    }//GEN-LAST:event_formWindowOpened

    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ArrayList<String> existingMaList = new ArrayList<>();
        for (MauSac existingMauSac : service.getListMauSac()) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (row != -1) {
            MauSac selected = service.getListMauSac().get(row);
            String ten = txtTen.getText();
            ...
            int confirmResult = JOptionPane.showConfirmDialog(
                    this,
                    "Bạn có chắc chắn muốn cập nhật màu sắc (id: " + selected.getId() + ")?",
                    "Xác nhận cập nhật",
